           ...
           <div class="card-body">
             ...
             <form action="<?= base_url; ?>/user/cari" method="post">
               ...
               <tr>
                 ...
                 <td><?= $row['nama'];?></td>
                 <td><?= $row['username'];?></td>
                <td> <a href="<?= base_url; ?>/user/edit/<?= $row['id'] ?>" class="badge badge-info ">Edit</a> <a href="<?= base_url; ?>/user/hapus/<?= $row['id'] ?>" class="badge badgedanger" onclick="return confirm('Hapus data?');">Hapus</a>
                 </td>
               </tr>
               <?php $no++; endforeach; ?>
            </tbody>
